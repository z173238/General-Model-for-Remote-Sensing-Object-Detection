...
if __name__ == '__main__':
    ...
    """
        model_info = dict(
            ...
            model_info = dict(
            val_using_aux=False,
            cfg_pth='A12_SelfTrain/A12_flex_rtm_v3_1_self_training.py',
            cfg_name='A12_flex_rtm_v3_1_self_training',
        )
            model_info = dict(
            val_using_aux=False,
    ...
    work_root = f'./results/TEST_EVAL/Formal_11_25_cross_{cfg_name}'
    ...
    for epoch in epochs:
        ...
        for data_name in ood_data_infos.keys():
            ...
            main(tst_cfg_pth,
                 ...
                 ann_dir=cfg['val_cross_ann_dir'], class_names=val_support_classes, img_scale=cfg['img_scale'],
