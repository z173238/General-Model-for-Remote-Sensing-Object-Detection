...
out_fig_pth = f'{data_root}/Step5_3_Prepare_Visual_Text_DINOv2_support_Text_Sims_New.png'
out_support_pth = f'{data_root}/Step5_3_Prepare_Visual_Text_DINOv2_support_New.pkl'
...
################################################################
from M_Tools.LabelSpace.Label3_Generate_Text_Prompts import Data7_HRSC2016
phrases = Data7_HRSC2016
classes = sorted(list(Data7_HRSC2016.keys()))
################################################################
