...
out_fig_pth = f'/data/space2/huangziyue/DOTA2_1024_500/train/Step5_3_Prepare_Visual_Text_DINOv2_support_Text_Sims.png'
out_support_pth = f'/data/space2/huangziyue/DOTA2_1024_500/train/Step5_3_Prepare_Visual_Text_DINOv2_support.pkl'
...
classification_ckpt_pth = ('/data/space2/huangziyue/mmdet_results/'
                           'F3_DETR_Classification_U03_Data1_DOTA2_DINOv2_VitL_gt_MLP/epoch_100.pth')
###############################################################
...
################################################################
from M_Tools.LabelSpace.Label3_Generate_Text_Prompts import Data1_DOTA2
phrases = Data1_DOTA2
classes = sorted(list(Data1_DOTA2.keys()))
################################################################
