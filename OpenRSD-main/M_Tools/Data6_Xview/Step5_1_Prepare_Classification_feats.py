...
CLASSES = ['Aircraft_Hangar', 'Barge', 'Building', 'Bus', 'Cargo/Container_Car',
           'Cargo_Truck', 'Cement_Mixer', 'Construction_Site', 'Container_Crane',
           'Container_Ship', 'Crane_Truck', 'Damaged_Building', 'Dump_Truck',
           'Engineering_Vehicle', 'Excavator', 'Facility', 'Ferry', 'Fishing_Vessel',
           'Fixed-wing_Aircraft', 'Flat_Car', 'Front_loader/Bulldozer', 'Ground_Grader',
           'Haul_Truck', 'Helicopter', 'Helipad', 'Hut/Tent', 'Locomotive',
           'Maritime_Vessel', 'Mobile_Crane', 'Motorboat', 'Oil_Tanker',
           'Passenger/Cargo_Plane', 'Passenger_Car', 'Passenger_Vehicle',
           'Pickup_Truck', 'Pylon', 'Railway_Vehicle', 'Reach_Stacker',
           'Sailboat', 'Scraper/Tractor', 'Shed', 'Shipping_Container',
           'Shipping_container_lot', 'Small_Aircraft', 'Small_Car', 'Storage_Tank',
           'Straddle_Carrier', 'Tank_car', 'Tower', 'Tower_crane', 'Trailer',
           'Truck', 'Truck_Tractor', 'Truck_Tractor_w/_Box_Trailer',
           'Truck_Tractor_w/_Flatbed_Trailer', 'Truck_Tractor_w/_Liquid_Tank',
