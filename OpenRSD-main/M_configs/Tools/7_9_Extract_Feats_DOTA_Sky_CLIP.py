...
train_class_name = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field',
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='train/7_4_Make_DOTA_with_SAM_IoU_01/',
...
custom_imports = dict(
    imports=[
        'M_AD.models.detectors.Tool_feat_patch_extractor_SkyClip',
    ],
...
model = dict(
    ...
    out_dir='/data/space2/huangziyue/DOTA_800_600/train/7_9_Extract_Feats_DOTA_Sky_CLIP',
