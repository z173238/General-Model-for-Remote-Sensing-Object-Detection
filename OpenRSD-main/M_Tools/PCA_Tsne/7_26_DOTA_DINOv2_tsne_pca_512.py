...
def preprocess_features(npdata, pca=512):
...
out_dir = f'/data/space2/huangziyue/DOTA_800_600/train/7_26_DOTA_DINOv2_tsne_pca_512'
mkdir(out_dir)
all_feats = []
img_count = 0
feat_count = 0
...
pklsave(output_info, out_dir + '/' + f'pca_meta.pkl')
