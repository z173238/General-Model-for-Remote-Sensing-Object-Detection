...
if __name__ == '__main__':
    ...
    for epoch in epochs:
        ...
        for data_name in data_infos.keys():
            ...
            results_pth = f'{results_dir}/{data_name}_{support_type}_mini_test.pkl'
            eval_pth = f'{results_dir}/{data_name}_{support_type}_mini_test.json'
            main(tst_cfg_pth,
                 ckpt_pth=ckpt_pth, work_dir=work_dir, results_pth=results_pth, eval_pth=eval_pth,
                 data_root='./data/MINI_Test_Dataset/Data28_STAR',
                 img_dir='images',
                 ann_dir='annotations',
                 class_names=cfg['class_names'], img_scale=cfg['img_scale'],
