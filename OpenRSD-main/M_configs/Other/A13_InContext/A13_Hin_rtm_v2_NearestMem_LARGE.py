...
# load_from = './results/MMR_AD_A13_Gen_rtm_v8_Ex_ECTHeadv2/epoch_20.pth'
# frozen_parameters = ['backbone', 'neck', 'bbox_head', 'rec_neck',
#                      'visual_support_mapping', 'text_support_mapping',
#                      'aux_bbox_head', 'aux_convs',
#                      'ict_nck']
# batch_size = 2
# data_root = '/data/space2/huangziyue'

load_from = './results/MMR_AD_A13_Hin_rtm_v2_NearestMem_LARGE/epoch_11.pth'
frozen_parameters = ['backbone', 'neck', 'bbox_head', 'rec_neck',
                     'visual_support_mapping', 'text_support_mapping',
                     'aux_bbox_head', 'aux_convs']
batch_size = 8
...
custom_imports = dict(
    imports=[
        ...
        'M_AD.models.detectors.Hindsight_Rtmdet_v2_NearestHead',
        'M_AD.models.dense_heads.Hindsight_Rrtmdet_head_v1',

        'M_AD.models.roi_heads.Hin_Box_Prompt_head_v1',
        'M_AD.models.roi_heads.bbox_heads.Hin_convfc_bbox_head',
...
model = dict(
    ...
    box_prompt_head=dict(
        type='HinBoxPromptHead',
        num_stages=1,
...
#################################################################################################
# Formatted_SelfLabels
SelfLabelDir = f'{data_root}/Formatted_SelfLabels_Ver5'
...
Data1_DOTA2_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data1_DOTA2',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data2_DIOR_R_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data2_DIOR_R',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data3_FAIR1M_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data3_FAIR1M',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data5_SpaceNet_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data5_SpaceNet',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data6_Xview_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data6_Xview',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data7_HRSC2016_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data7_HRSC2016',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data8_GLH_Bridge_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data8_GLH_Bridge',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data11_WHU_Mix_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data11_WHU_Mix',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
Data12_ShipImageNet_SelfLabel = dict(
    ...
    data_prefix=dict(img_path='images/'),
    ##########################
    ann_file=f'{SelfLabelDir}/Data12_ShipImageNet',
    embed_dims=embed_dims,
    ##########################
    img_shape=img_scale,
    filter_cfg=dict(filter_empty_gt=True),
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='mmdet.ConcatDataset', datasets=[Data1_DOTA2,
                                              ...
                                              Data1_DOTA2_SelfLabel,
                                              Data2_DIOR_R_SelfLabel,
                                              Data3_FAIR1M_SelfLabel,
                                              Data5_SpaceNet_SelfLabel,
                                              Data6_Xview_SelfLabel,
                                              Data7_HRSC2016_SelfLabel,
                                              Data8_GLH_Bridge_SelfLabel,
