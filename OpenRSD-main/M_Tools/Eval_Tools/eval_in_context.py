...
def main(tst_cfg_pth, ckpt_pth, work_dir, results_pth, eval_pth,
    ...
    cfg.test_dataloader.dataset.type = 'DOTADatasetOnline'
    cfg.test_dataloader.dataset.auto_generate_labels = True
    cfg.test_dataloader.dataset.normalized_class_dict = './data/normalized_class_dict.pkl'

    cfg.model.val_using_ict = False
...
if __name__ == '__main__':
    ...
    for exp_name, model_info in exp_infos.items():
        ...
        eval_results_root = f'{work_root}/11_29_InContext_{prefix}_Epoch_{epoch}_wo_ICT'
        if val_using_aux:
        ...
        for data_name in data_infos.keys():
            # if data_name not in ['Data1_DOTA2',]:
            #     continue
            if data_name not in ['Data1_DOTA2', 'Data2_DIOR_R',
                                 'Data3_FAIR1M', 'Data4_HRRSD', 'Data5_SpaceNet',
                                 'Data6_Xview', 'Data7_HRSC2016',
            ...
            main(tst_cfg_pth,
                 ...
                 ann_dir=f'/data/space2/huangziyue/Formatted_FederatedLabels_InContext_Validate/'
                         f'{data_name}',
