...
class DNARSRotatedDeformableDetrDecoder(DetrTransformerDecoder):
    def __init__(self,
                 as_two_stage=False,
                 num_feature_levels=5,
                 two_stage_num_proposals=300,
                 **kwargs):
        super(DNARSRotatedDeformableDetrDecoder, self).__init__(**kwargs)
...
class DNARSDeformableDetrTransformerDecoder(TransformerLayerSequence):

    def __init__(self, *args, return_intermediate=False, **kwargs):
        super(DNARSDeformableDetrTransformerDecoder, self).__init__(*args, **kwargs)
        self._init_layers()
