...
def main():
    ...
    out_ann_pth = f'{proj_root}/M_Tools/ICCV_Figures/{support_type}_AnyDet_{cfg_name}.pkl'
    ...
    with torch.no_grad():
        for data_info in data_loader:
            ...
            align_results = model.prompt_predict(
                deepcopy(feat_x),
                data['inputs'],
            ...
            align_pred_boxes, align_pred_scores, align_pred_labels, \
                ...
                get_pred_results(align_results, id2name,
            ...
            for img_id in range(n_img):
                ...
                cls_list = latent_classes[img_id]
                if len(nms_bboxes) == 0:
