parent_mapping = dict(
    ...
    Data12_ShipImageNet={
        ...
        'container_ship': 'ship',
        # Container ships are vessels designed to carry standardized containers, classified under 'ship'.
        'dock': 'transportation_area',
        # A dock is part of a port or harbor where ships are loaded/unloaded, categorized as 'transportation_area'.
        'enterprise': 'ship',  # Likely referring to USS Enterprise, an aircraft carrier, classified under 'aircraft'.
        'epf': 'ship',
        # Expeditionary Fast Transport, used for high-speed military logistics, is categorized under 'ship'.
        ...
        'hovercraft': 'ship',
        # Hovercrafts are amphibious vehicles, capable of traveling over land and water, classified as 'vehicle'.
        ...
        'other_aircraft_carrier': 'ship',
        # Other aircraft carriers are classified under 'aircraft' as they support aircraft operations.
...
uni_cls2parent = dict()
uni_parent2cls = dict()
for data_name, mappings in parent_mapping.items():
    for cls, parent in mappings.items():
        uni_cls2parent[cls] = parent
        if parent not in uni_parent2cls:
            uni_parent2cls[parent] = []
        uni_parent2cls[parent].append(cls)
