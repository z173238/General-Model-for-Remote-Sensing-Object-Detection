...
classification_ckpt_pth = ('/data/space2/huangziyue/mmdet_results/'
                           'F3_DETR_Classification_U03_Data6_Xview_New_DINOv2_VitL_gt_MLP/epoch_100.pth')
###############################################################
...
################################################################
from M_Tools.LabelSpace.Label3_Generate_Text_Prompts import Data6_Xview
phrases = Data6_Xview
classes = sorted(list(Data6_Xview.keys()))
################################################################
