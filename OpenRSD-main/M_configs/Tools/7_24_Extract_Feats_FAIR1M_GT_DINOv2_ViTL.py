...
train_class_name = ['A220', 'A321', 'A330', 'A350', 'ARJ21',
                              'Baseball', 'Basketball',
                              'Boeing737', 'Boeing747', 'Boeing777', 'Boeing787',
                              'Bridge', 'Bus', 'C919', 'Cargo', 'Dry', 'Dump',
                               'Engineering', 'Excavator', 'Fishing', 'Football',
                               'Intersection', 'Liquid', 'Motorboat', 'Passenger',
                               'Roundabout', 'Small', 'Tennis', 'Tractor', 'Trailer',
                               'Truck', 'Tugboat', 'Van', 'Warship', 'other-airplane',
...
model = dict(
    ...
    out_dir='/data/space2/huangziyue/FAIR1M_1024_0/train/7_24_Extract_Feats_FAIR1M_GT_DINOv2_ViTL',
