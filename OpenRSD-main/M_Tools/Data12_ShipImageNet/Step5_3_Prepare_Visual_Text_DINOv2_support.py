...
classification_ckpt_pth = ('/data/space2/huangziyue/mmdet_results/'
                           'F3_DETR_Classification_U03_Data12_ShipImageNet_DINOv2_VitL_gt_MLP/epoch_100.pth')
###############################################################
...
################################################################
from M_Tools.LabelSpace.Label3_Generate_Text_Prompts import Data12_ShipImageNet
phrases = Data12_ShipImageNet
classes = sorted(list(Data12_ShipImageNet.keys()))
################################################################
