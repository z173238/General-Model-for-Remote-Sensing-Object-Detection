...
classification_ckpt_pth = ('/data/space2/huangziyue/mmdet_results/'
                           'F3_DETR_Classification_U03_Data9_FMow_DINOv2_VitL_gt_MLP/epoch_100.pth')
###############################################################
...
################################################################
from M_Tools.LabelSpace.Label3_Generate_Text_Prompts import Data9_FMoW
phrases = Data9_FMoW
classes = sorted(list(Data9_FMoW.keys()))
################################################################
