...
class DOTACustomDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        ####################################
        self.obj_embed_dir = obj_embed_dir
        self.eval_ious = eval_ious
        ####################################
    ...
    def load_data_list(self) -> List[dict]:
        ...
        if self.ann_file == '':
            ...
            for txt_file in txt_files:
                ...
                # if img_id not in ['00568', '04137', '04720', '00372',
                #                   '23455', '12460', '16740', '15146']:
                #     continue
                data_info['img_id'] = img_id
                img_name = img_id + '.png'
                data_info['file_name'] = img_name
                ...
                data_info['width'] = self.img_shape[1]
                ###########
                if self.obj_embed_dir != '':
                    ex_ann_pth = self.obj_embed_dir + '/' + Path(txt_file).stem + '.pkl'
                    obj_embeds = pklload(ex_ann_pth, msg=False)['pca_feats']
                ###########
                instances = []
                with open(txt_file) as f:
                    ...
                    for si in s:
                        ...
                        ######
                        if self.obj_embed_dir != '':
                            if embed_id > len(obj_embeds):
                                print(f'Warning, embeddings not enough for txt_file: {txt_file}')
                                embed_id = 0
                            instance['obj_embed'] = obj_embeds[embed_id]
                        ######
